...
//					g.drawImage(m_oCanvas.m_oImageArray[1],(x*25)-165,(y*25)+m_iWaterMoveOffset-20,Graphics.TOP | Graphics.LEFT);
		...
		{
			g.setColor(0,0,0);
			m_oCanvas.DrawString("Press [0] or [5] to fire",(m_oCanvas.m_iWidth/2)-64,(m_oCanvas.m_iHeight/2),false,1);
		}
	}
...
*/
	...
	//------------------------------------------------------
	{
		...
		if(iKey == Canvas.KEY_NUM5 || iKey == Canvas.KEY_NUM0){m_bFire  = true;		m_oCanvas.m_oStateGame.m_bShotButtonGuide = false;}
