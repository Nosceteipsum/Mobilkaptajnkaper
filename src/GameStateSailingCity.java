...
//------------------------------------------------------
{
	...
	//------------------------------------------------------
	{
		...
		//Ship
			...
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-90,((m_iShipY/9)*9)-49,Graphics.TOP | Graphics.LEFT);	
			g.setClip(((m_iShipX/9)*9)-9,((m_iShipY/9)*9)-9,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-99,((m_iShipY/9)*9)-49,Graphics.TOP | Graphics.LEFT);	
			g.setClip(((m_iShipX/9)*9)+9,((m_iShipY/9)*9)-9,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-81,((m_iShipY/9)*9)-49,Graphics.TOP | Graphics.LEFT);	

			g.setClip(((m_iShipX/9)*9)+9,((m_iShipY/9)*9)-0,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-81,((m_iShipY/9)*9)-40,Graphics.TOP | Graphics.LEFT);	
			g.setClip(((m_iShipX/9)*9)-0,((m_iShipY/9)*9)-0,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-90,((m_iShipY/9)*9)-40,Graphics.TOP | Graphics.LEFT);	
			g.setClip(((m_iShipX/9)*9)-9,((m_iShipY/9)*9)-0,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-99,((m_iShipY/9)*9)-40,Graphics.TOP | Graphics.LEFT);	
/*
			g.setClip(((m_iShipX/9)*9)-9,((m_iShipY/9)*9)+9,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-99,((m_iShipY/9)*9)-31,Graphics.TOP | Graphics.LEFT);	
			g.setClip(((m_iShipX/9)*9)-0,((m_iShipY/9)*9)+9,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-90,((m_iShipY/9)*9)-31,Graphics.TOP | Graphics.LEFT);	
			g.setClip(((m_iShipX/9)*9)+9,((m_iShipY/9)*9)+9,9,9);
			g.drawImage(m_oCanvas.m_oImageArray[1],((m_iShipX/9)*9)-81,((m_iShipY/9)*9)-31,Graphics.TOP | Graphics.LEFT);	
*/
			m_iShipX -= 5;
			m_iShipY -= 5;
		...
		if(m_bPaused)
		{
			...
			if(m_iStatus == 5)
			{
				if(m_iWind != 0)
				{
					if(m_iWind < 0)
					{
						m_oCanvas.DrawString("Watch out for wind (<<<)",(m_oCanvas.m_iWidth/2)-58,(m_oCanvas.m_iHeight/2),false,1);
					}
					if(m_iWind > 0)
					{
						m_oCanvas.DrawString("Watch out for wind (>>>)",(m_oCanvas.m_iWidth/2)-58,(m_oCanvas.m_iHeight/2),false,1);
			...
			if(m_iStatus == 1)m_oCanvas.DrawString("You docked.",(m_oCanvas.m_iWidth/2)-58,(m_oCanvas.m_iHeight/2),true,1);
			if(m_iStatus == 2)m_oCanvas.DrawString("You crashed.",(m_oCanvas.m_iWidth/2)-58,(m_oCanvas.m_iHeight/2),true,1);

			m_oCanvas.DrawString("Press [5] to continue",(m_oCanvas.m_iWidth/2)-58,(m_oCanvas.m_iHeight/2+10),false,1);
		}
	}	
