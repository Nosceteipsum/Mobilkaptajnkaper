...
//------------------------------------------------------
{
	...
	//------------------------------------------------------
	{
		...
		g.drawString("City trade center",(m_oCanvas.m_iWidth/2)-55,0,Graphics.TOP | Graphics.LEFT);

		g.drawString(m_sCityName,(m_oCanvas.m_iWidth/2)-35,13,Graphics.TOP | Graphics.LEFT);
		...
		{
			g.drawString("g",(m_oCanvas.m_iWidth/2)- 8,26,Graphics.TOP | Graphics.LEFT);
				stringBuffer.delete(0,stringBuffer.length());
				stringBuffer.append((int)(m_iFoodPriceBuy*m_iAmount));
				stringBuffer.getChars(0,stringBuffer.length(),stringChars,0);
				g.drawChars(stringChars,0,stringBuffer.length(),(m_oCanvas.m_iWidth/2)-28,26,Graphics.TOP | Graphics.LEFT);

			g.drawString("g",(m_oCanvas.m_iWidth/2)+57,26,Graphics.TOP | Graphics.LEFT);
				stringBuffer.delete(0,stringBuffer.length());
				stringBuffer.append((int)(m_iFoodPriceSell*m_iAmount));
				stringBuffer.getChars(0,stringBuffer.length(),stringChars,0);
				g.drawChars(stringChars,0,stringBuffer.length(),(m_oCanvas.m_iWidth/2)+37,26,Graphics.TOP | Graphics.LEFT);
		}
		...
		g.drawString("Buy:" ,(m_oCanvas.m_iWidth/2)-50,26,Graphics.TOP | Graphics.LEFT);
		g.drawString("Sell:",(m_oCanvas.m_iWidth/2)+10,26,Graphics.TOP | Graphics.LEFT);
		
		g.setClip(0,40,m_oCanvas.m_iWidth,m_oCanvas.m_iHeight);
		

		g.drawString("Amount",(m_oCanvas.m_iWidth/2)-30,iYOffSet+(m_oCanvas.m_iHeight/2)-50,Graphics.TOP | Graphics.LEFT);
			stringBuffer.delete(0,stringBuffer.length());
			stringBuffer.append((int)m_iAmount);
			stringBuffer.getChars(0,stringBuffer.length(),stringChars,0);
			g.drawChars(stringChars,0,stringBuffer.length(),(m_oCanvas.m_iWidth/2)+15,iYOffSet+(m_oCanvas.m_iHeight/2)-50,Graphics.TOP | Graphics.LEFT);

		g.setColor(100,100,100);
		g.drawString("Grain",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-35,Graphics.TOP | Graphics.LEFT);
		g.drawString("Crew",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-25   ,Graphics.TOP | Graphics.LEFT);
		g.drawString("Cannons",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-15,Graphics.TOP | Graphics.LEFT);

		if(m_oCanvas.m_oStateGame.m_iShipLvl == 1)g.drawString("Ship L2",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 2)g.drawString("Ship L3",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 3)g.drawString("Ship L4",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 4)g.drawString("Ship L5",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 5)g.drawString("Ship L6",(m_oCanvas.m_iWidth/2)-40,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);

		for(int i=0;i< 4;i++)
		{
			g.drawString("<>",(m_oCanvas.m_iWidth/2)+7,iYOffSet+(m_oCanvas.m_iHeight/2)-35+(i*10),Graphics.TOP | Graphics.LEFT);
		}

		g.setColor(200,200,0);

		g.drawString("g",(m_oCanvas.m_iWidth/2)+40,iYOffSet+(m_oCanvas.m_iHeight/2)-35,Graphics.TOP | Graphics.LEFT);
			stringBuffer.delete(0,stringBuffer.length());
			stringBuffer.append((int)m_iFoodPriceBuy);
			stringBuffer.getChars(0,stringBuffer.length(),stringChars,0);
			g.drawChars(stringChars,0,stringBuffer.length(),(m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-35,Graphics.TOP | Graphics.LEFT);

		g.drawString("g",(m_oCanvas.m_iWidth/2)+40,iYOffSet+(m_oCanvas.m_iHeight/2)-25,Graphics.TOP | Graphics.LEFT);
			stringBuffer.delete(0,stringBuffer.length());
			stringBuffer.append((int)m_iPiratePriceBuy);
			stringBuffer.getChars(0,stringBuffer.length(),stringChars,0);
			g.drawChars(stringChars,0,stringBuffer.length(),(m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-25,Graphics.TOP | Graphics.LEFT);

		g.drawString("g",(m_oCanvas.m_iWidth/2)+40,iYOffSet+(m_oCanvas.m_iHeight/2)-15,Graphics.TOP | Graphics.LEFT);
			stringBuffer.delete(0,stringBuffer.length());
			stringBuffer.append((int)m_iCannonPriceBuy);
			stringBuffer.getChars(0,stringBuffer.length(),stringChars,0);
			g.drawChars(stringChars,0,stringBuffer.length(),(m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-15,Graphics.TOP | Graphics.LEFT);


		if(m_oCanvas.m_oStateGame.m_iShipLvl == 1)g.drawString("150 g",                                   (m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 2)g.drawString("200 g",                                   (m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 3)g.drawString("400 g",                                   (m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 4)g.drawString("600 g",                                  (m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);
		if(m_oCanvas.m_oStateGame.m_iShipLvl == 5)g.drawString("1500 g",                                  (m_oCanvas.m_iWidth/2)+20,iYOffSet+(m_oCanvas.m_iHeight/2)-5,Graphics.TOP | Graphics.LEFT);

		g.setColor(100,0,0);
		g.drawString("Exit",(m_oCanvas.m_iWidth/2)-10,iYOffSet+(m_oCanvas.m_iHeight/2)+10,Graphics.TOP | Graphics.LEFT);
